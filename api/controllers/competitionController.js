...
exports.create = function(req, res) {
    Competitions.create(req.getConnection, req.body, req.username, function(insertedId) {
        if (insertedId) {
...
exports.find = function(req, res) {
    Competitions.find(req.getConnection, req.params.competitionId, function(store) {
